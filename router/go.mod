module github.com/ml-serving-platform/router
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/dynamodbstreams v1.17.7 // indirect
	...
	github.com/smithy-go v1.19.0 // indirect
